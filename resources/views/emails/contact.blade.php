    ...
    <div style="background: #85B840 ; width: 700px; padding: 50px; font-family: Arial, Helvetica, sans-serif; font-size: 14px;">
        <div style="width: 90%; background: #fff; margin: auto; padding: 25px; text-align: left;">
            ...
            <div style="text-align: left; margin-top: 50px;">
                <div style="font-weight: bold;">Dear {{ $contact->full_name }},</div>
                <p>Thank you for writing to us. We have received your message and will get back to you shortly. Here are the detail of your enquiry.</p>
